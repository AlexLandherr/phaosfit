...
/**
 * fitter_decimal_ratio() - Compute all pixel rasters that match a given aspect ratio.
 * @ratio: Pointer to the aspect ratio object.
 * @dst_array: Pointer to the raster_pair_array object that will hold all computed rasters.
 * 
 * Computes all pixel rasters that match a given aspect ratio when W is a decimal value and H is an integer.
 * See function definition for algorithm details in 'fitter.c'
 * 
 * Context: Any context.
 * Return: None.
